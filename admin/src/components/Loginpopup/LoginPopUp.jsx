...
const LoginPopUp = () => {
  ...
  return (
    <>
      <img className="wave" src={wave} alt="wave" data-aos='zoom-out-right'  />
      <div className="container ans">
        ...
        <div className="login-content">
          <form onSubmit={onLogin}>
            ...
            <h2 className="title" data-aos='fade-right'>Welcome</h2>
            <div className="input-div one" data-aos='fade-zoom-out'>
            ...
            <div className="input-div pass" data-aos='fade-left'>
              <div className="i">
            ...
            <input type="submit" className="btn" value="Login" data-aos='fade-up' />
          </form>
        </div>
        <ToastContainer />
      </div>
